...
import bench from "../assets/variation5/asset 3.png"
...
import service from "../assets/variation5/asset 10.png"
import product from "../assets/variation5/asset 11.png"
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <div>
                    <a
                      href="#"
                      className='relative z-10 font-bold bg-[#3577F0] text-white px-24 py-4 rounded-md 
                                                before:absolute
                                                before:content-[""]
                                                before:bg-[#3577F0]
                                                before:left-0
              ...
              <div className="FORM grid grid-cols-2 gap-20">
                ...
                <div className="text-gray-500">
                  ...
                  <div>
                    <a
                      href="#"
                      className='relative z-10 font-bold bg-[#3577F0] text-white px-24 py-4 rounded-md mt-24 
                                                before:absolute
                                                before:content-[""]
                                                before:bg-[#3577F0]
                                                before:left-0
